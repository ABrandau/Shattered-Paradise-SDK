...
namespace OpenRA.Mods.SP.Traits.Render
{
	...
	public class WithIdleFacingOverlayInfo : WithIdleOverlayInfo
	{
		public override object Create(ActorInitializer init) { return new WithIdleFacingOverlay(init.Self, this); }
	...
	public class WithIdleFacingOverlay : PausableConditionalTrait<WithIdleFacingOverlayInfo>, INotifyDamageStateChanged
	{
		readonly Animation overlay;
		readonly IFacing facing;

		public WithIdleFacingOverlay(Actor self, WithIdleFacingOverlayInfo info)
			: base(info)
		{
			...
			overlay = new Animation(self.World, image, () => facing.Facing, () => IsTraitPaused)
			{
